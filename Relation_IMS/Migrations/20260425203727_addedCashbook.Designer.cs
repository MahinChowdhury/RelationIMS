...
namespace Relation_IMS.Migrations
{
    ...
    [Migration("20260425203727_addedCashbook")]
    partial class addedCashbook
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Relation_IMS.Models.AccountModels.CashBookEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Relation_IMS.Models.AccountModels.CashTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Relation_IMS.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Relation_IMS.Models.OrderModels.OrderItem", b =>
                {
                    ...
                    b.Property<decimal>("CostBD")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CostRMB")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Relation_IMS.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            PasswordHash = "$2a$11$TQ0bA62lLsYE9tXx.k4dDOmR3kin3U5g6aFvxU9z3me866e5iVR.e",
            ...
            modelBuilder.Entity("Relation_IMS.Models.AccountModels.CashBookEntry", b =>
                {
                    b.HasOne("Relation_IMS.Models.AccountModels.CashTransfer", "CashTransfer")
                        .WithMany()
                        .HasForeignKey("CashTransferId");

                    b.HasOne("Relation_IMS.Models.PaymentModels.OrderPayment", "OrderPayment")
                        .WithMany()
